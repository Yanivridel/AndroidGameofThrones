...
import com.example.loginsignup.activities.MainActivity;
...
public class fragment_register extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button submitRegisterButton = view.findViewById(R.id.submit_register_button);

        submitRegisterButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                //make logic for failure
                //Toast.makeText(getContext(), "This is Wrong", Toast.LENGTH_LONG).show();

                MainActivity mainActivity = (MainActivity) getActivity();
                mainActivity.register();
                mainActivity.addDataToDB();

                //Navigation.findNavController(view).navigate(R.id.action_fragment_register_to_fragment_menu);
            }
        });
